...
let driver = new Builder().forBrowser('firefox')
            ...
            .usingServer('http://39ad4963.ngrok.io:4444/wd/hub') // Conectamos a nuestro enjambre de navegadores listos para ejecutar nuestras tareas //Servidor para el anjambre
            .setFirefoxOptions(
