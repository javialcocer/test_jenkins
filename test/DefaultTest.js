...
let driver = new Builder().forBrowser('firefox')
            ...
            .usingServer('http://33015c2a.ngrok.io:4444/wd/hub') // Conectamos a nuestro enjambre de navegadores listos para ejecutar nuestras tareas //Servidor para el anjambre
            .setFirefoxOptions(
